...
Версия: 3.3 (с функцией выдачи тега в админке)
"""
...
def kb_main_menu(in_party: bool = False):
    """Главное меню — 8 кнопок в 2 ряда по 4"""
...
def main():
    ...
    logger.info("=" * 50)
    logger.info("🤖 Stranger Faceit 3.3 запущен!")
